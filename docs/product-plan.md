...
| [`security-and-permissions.md`](security-and-permissions.md) | 执行安全、智能体能力边界、权限和数据边界 |
| [`human-role.md`](human-role.md) | 人在系统中的作用、人机协作原则和授权边界 |
| [`memory-architecture.md`](memory-architecture.md) | 三层记忆架构、检索流程、MVP 范围和治理原则 |
| [`lark-cli-capability-matrix.md`](lark-cli-capability-matrix.md) | 阶段 0.5 Lark CLI / `lark-okr` 能力验证清单 |
