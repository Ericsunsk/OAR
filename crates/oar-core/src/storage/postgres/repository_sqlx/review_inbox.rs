...
pub(super) use read_model::load_review_decision_context_from_pool;
use read_model::load_review_inbox_snapshot_from_pool;
...
impl PostgresReviewInboxRepository {
    ...
    pub async fn load_review_inbox_snapshot(
        ...
        load_review_inbox_snapshot_from_pool(&self.pool, tenant_id, user_id, after_cursor, limit)
            .await
    }
