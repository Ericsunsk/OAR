...
pub(in crate::agent::skills) const PURPOSE: &str =
    "理解用户关于本人飞书 OKR、目标、关键结果、数量、内容概览和 progress 进展的查询。";
...
pub(in crate::agent::skills) const TOOLS: &[AgentSkillToolSpec] = &[
    AgentSkillToolSpec {
    ...
    AgentSkillToolSpec {
        ...
        description: "后端只读汇总当前用户的 Feishu OKR 进展、最近更新、延期和风险信号。",
    },
];
